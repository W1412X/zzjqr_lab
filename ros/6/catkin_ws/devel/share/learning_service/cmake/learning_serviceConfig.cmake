...
if("TRUE" STREQUAL "TRUE")
  set(learning_service_SOURCE_PREFIX /home/wangxv/Files/hw/jqr/ros/6/catkin_ws/src/learning_service)
  set(learning_service_DEVEL_PREFIX /home/wangxv/Files/hw/jqr/ros/6/catkin_ws/devel)
  ...
  set(learning_service_INSTALL_PREFIX /home/wangxv/Files/hw/jqr/ros/6/catkin_ws/install)
...
if(NOT "/home/wangxv/Files/hw/jqr/ros/6/catkin_ws/devel/include " STREQUAL " ")
  set(learning_service_INCLUDE_DIRS "")
  set(_include_dirs "/home/wangxv/Files/hw/jqr/ros/6/catkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'wangxv <wangxv@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'learning_service' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wangxv/Files/hw/jqr/ros/6/catkin_ws/src/learning_service/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/wangxv/Files/hw/jqr/ros/6/catkin_ws/devel/lib;/opt/ros/noetic/lib)
...
set(depends "geometry_msgs;roscpp;rospy;stdmsgs;turtlesim;message_runtime")
